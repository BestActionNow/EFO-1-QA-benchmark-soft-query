...
if __name__ == "__main__":
    raw_data_path = "data/raw/ppi5k"
    processed_data_path = "data/processed/ppi5k"
    ...
    df = pd.read_csv(os.path.join(raw_data_path, "relation_id.csv"), sep=',', header=None, names=['id', 'rel'])
    rel2id, id2rel = {}, {}
    for idx, row in df.iterrows():
